...
namespace Lidarr.Plugin.Common.Services.Network
{
    ...
    public class NetworkResilienceService
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            _logger.LogInformation("🛡️ RESILIENT BATCH START: Operation '{0}' with {1} items", operationId, itemList.Count);
            ...
            CancellationToken cancellationToken)
        {
            ...
            for (int i = startIndex; i < items.Count; i++)
            {
                ...
                else
                {
                    ...
                    {
                        _logger.LogError("🚫 BATCH FAILED: Stopping at first failure for operation '{0}' at item {1}",
                                     batchState.OperationId, i);
        ...
        private bool IsCircuitBreakerOpen()
        {
            ...
            {
                _logger.LogInformation("🔄 CIRCUIT BREAKER: Attempting to close circuit after timeout");
        ...
        private void RecordSuccess()
        {
            ...
            {
                _logger.LogInformation("✅ CIRCUIT BREAKER: Resetting failure count after successful operation");
...
#pragma warning disable CS1998
        ...
        private async Task CleanupOperationAsync(string operationId)
        {
            try
            {
                ...
                _logger.LogDebug("🧹 CLEANUP: Removed completed operation '{0}'", operationId);
            }
            catch (Exception ex)
            {
