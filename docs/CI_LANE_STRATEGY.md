...
```
State!=Quarantined&((Area=E2E/Hermetic)|(Area!=Live&Area!=E2E/Live&Category!=Benchmark&Category!=Integration&Category!=Live&Category!=LiveIntegration&Category!=Docker&Category!=DockerE2E&Category!=ReleaseE2E&Category!=Runtime))
```
